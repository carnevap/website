...
export const experienceData: IExperience[] = [
...

  {
    ...
    points: ['Developed learning resources, including videos, graphics, websites, and animations', 'Designed visual elements for student and faculty educational content', ''Implemented monitoring tools and procedures to identify potential issues proactively and mitigate risks', 'Ensured system stability and reliability through continuous infrastructure maintenance', 'Facilitated communication between IT teams and end-users to ensure timely issue resolution'],
  },
];
